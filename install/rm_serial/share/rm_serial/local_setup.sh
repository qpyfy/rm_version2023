...
: ${AMENT_CURRENT_PREFIX:="/rm_version/install/rm_serial"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm_serial/environment/library_path.sh"
