...
: ${AMENT_CURRENT_PREFIX:="/rm_version/install/start_directory"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/start_directory/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/start_directory/environment/path.sh"
