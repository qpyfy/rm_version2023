...
#define NODE_MAIN_LOGGER_NAME "ros2_video_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libros2_video.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ros2_video_node::VideoNode>";
