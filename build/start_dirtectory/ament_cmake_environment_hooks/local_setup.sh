...
: ${AMENT_CURRENT_PREFIX:="/rm_version/install/start_dirtectory"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/start_dirtectory/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/start_dirtectory/environment/path.sh"
