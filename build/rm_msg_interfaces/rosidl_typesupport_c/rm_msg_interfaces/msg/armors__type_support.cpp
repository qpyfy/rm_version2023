...
static const _Armors_type_support_symbol_names_t _Armors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_msg_interfaces, msg, Armors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_msg_interfaces, msg, Armors)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_msg_interfaces, msg, Armors)() {
  return &::rm_msg_interfaces::msg::rosidl_typesupport_c::Armors_message_type_support_handle;
}
