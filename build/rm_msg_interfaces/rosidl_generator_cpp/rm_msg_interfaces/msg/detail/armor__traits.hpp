...
#ifndef RM_MSG_INTERFACES__MSG__DETAIL__ARMOR__TRAITS_HPP_
#define RM_MSG_INTERFACES__MSG__DETAIL__ARMOR__TRAITS_HPP_
...
inline void to_yaml(
  const rm_msg_interfaces::msg::Armor & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rm_msg_interfaces::msg::Armor & msg)
{
  return rm_msg_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rm_msg_interfaces::msg::Armor>()
{
  return "rm_msg_interfaces::msg::Armor";
}

template<>
inline const char * name<rm_msg_interfaces::msg::Armor>()
{
  return "rm_msg_interfaces/msg/Armor";
}

template<>
struct has_fixed_size<rm_msg_interfaces::msg::Armor>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rm_msg_interfaces::msg::Armor>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rm_msg_interfaces::msg::Armor>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RM_MSG_INTERFACES__MSG__DETAIL__ARMOR__TRAITS_HPP_
