...
#include "rm_msg_interfaces/msg/detail/armor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_msg_interfaces::msg::Armor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_msg_interfaces::msg::Armor & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
...
{
  auto typed_message =
    static_cast<const rm_msg_interfaces::msg::Armor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_msg_interfaces::msg::Armor *>(
    untyped_ros_message);
...
{
  return &rm_msg_interfaces::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_msg_interfaces, msg, Armor)() {
  return &rm_msg_interfaces::msg::typesupport_fastrtps_cpp::_Armor__handle;
}
