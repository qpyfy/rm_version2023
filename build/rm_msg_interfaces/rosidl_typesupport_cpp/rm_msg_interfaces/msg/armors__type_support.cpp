...
static const _Armors_type_support_symbol_names_t _Armors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_msg_interfaces, msg, Armors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_msg_interfaces, msg, Armors)),
  }
};
...
{
  return &::rm_msg_interfaces::msg::rosidl_typesupport_cpp::Armors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_msg_interfaces, msg, Armors)() {
  return get_message_type_support_handle<rm_msg_interfaces::msg::Armors>();
}
