...
bool rm_msg_interfaces__msg__tracker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_msg_interfaces.msg._tracker.Tracker", full_classname_dest, 38) == 0);
  }
  rm_msg_interfaces__msg__Tracker * ros_message = _ros_message;
  {  // header
  ...
  {  // trackering
    PyObject * field = PyObject_GetAttrString(_pymsg, "trackering");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->trackering = (Py_True == field);
    Py_DECREF(field);
  }
  {  // id
...
PyObject * rm_msg_interfaces__msg__tracker__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_msg_interfaces.msg._tracker");
  ...
  {  // trackering
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->trackering ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "trackering", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
