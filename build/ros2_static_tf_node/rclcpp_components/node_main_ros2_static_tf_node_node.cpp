...
#define NODE_MAIN_LOGGER_NAME "ros2_static_tf_node_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libros2_static_tf_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ros2_static_tf_node::TfNode>";
