...
#define NODE_MAIN_LOGGER_NAME "rm_serial_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_serial.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<Serial_Node>";
